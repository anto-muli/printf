...
/**
 * print_unsigned - Prints the allocated unsigned #
 * @types: List a of args in the function
...
/**
 * output_octal - Outputs an unsigned # in octal notation
 * @types: Lists of args
...
/**
 * output_hexadecimal - Outputs an unsigned # in hexadecimal notation
 * @types: Lists of args
...
/**
 * output_upper_hexa - Prints an unsigned number in upper hexadecimal notation
...
/**
 * output_hexas - Outputs a hexadecimal #s in lower or upper
 * @types: Lists  args
